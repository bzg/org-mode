...
* Current Version (6.23b)

The current version is 6.23b.  To see what has changed in recent
...
Download as [[file:org-6.23b.zip][zip file]] or [[file:org-6.23b.tar.gz][gzipped tar archive]].  These archives contain
