...
* Current Version (6.15d) and Compatibility

The current version is 6.15d.  To see what has changed in recent
...
to ship with 6.15d.  The latest CVS emacs trunk usually contains a
...
Download as [[file:org-6.15d.zip][zip file]] or [[file:org-6.15d.tar.gz][gzipped tar archive]].  These archives contain
