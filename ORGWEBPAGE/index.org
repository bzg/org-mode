...
* Current Version (6.21b)

The current version is 6.21b.  To see what has changed in recent
...
Download as [[file:org-6.21b.zip][zip file]] or [[file:org-6.21b.tar.gz][gzipped tar archive]].  These archives contain
...
I keep current with Org mode development?]].  For people who cannot
use git for one reason or another we provide
[[file:org-snapshot.zip][zip]] or [[file:org-snapshot.tar.gz][tar.gz]]
snapshot files.
