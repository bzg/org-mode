...
* Current Version (6.12a) and Compatibility

The current version is 6.12a.  To see what has changed in recent
...
to ship with 6.09a. The latest CVS emacs trunk usually contains a
...
Download as [[file:org-6.12a.zip][zip file]] or [[file:org-6.12a.tar.gz][gzipped tar archive]].  These archives contain
...
** Alternative distributions
   ...
   - The [[http://pdb.finkproject.org/pdb/package.php/org-mode][Fink package]] for Mac OS X by Jese Alama
