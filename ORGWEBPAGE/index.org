...
- Depth :: As needs arise, Org-mode will show it's amazingly broad and
     deep feature set.  Simple as it is initially, it will not let you
     down when you need more.  The typical [[http://orgmode.org/worg/org-faq.php][answer]] to "/Can I do X?/" is
     "/Yes!/".
