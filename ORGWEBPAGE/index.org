  ...
  <table width="100%">
    <tr>
      ...
      <img src="http://orgmode.org/img/shirts.jpg" 
             ...
             Get your Org-mode T-Shirt, bag or cup in our stores 
         (<a href="http://orgmode.spreadshirt.com">US-Shop</a> or
         <a href="http://orgmode.spreadshirt.de">EU-Shop</a>), to
      support Org-mode in this way ...</span>
      ...
      <td style="vertical-align:bottom;">
        <div style="float:bottom; border:0px solid black; 
            ...
            <form  style="float:left;padding:3px; name="_xclick" 
          ...
          <span style="font-size: 80%;">
            ... or <a href="http://thread.gmane.org/gmane.emacs.orgmode/14209">support
            Org-mode development</a> with a direct donation.</span>
        </div>
      </td>
    </tr>
    </table>
