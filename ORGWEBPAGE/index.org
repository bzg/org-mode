...
* Current Version (6.08) and Compatibility

The current version is 6.08.  To see what has changed in recent
...
Download as [[file:org-6.08.zip][zip file]] or [[file:org-6.08.tar.gz][gzipped tar archive]].  These archives contain
