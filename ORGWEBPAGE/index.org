...
* Current Version (6.12b) and Compatibility

The current version is 6.12b.  To see what has changed in recent
...
to ship with 6.12a. The latest CVS emacs trunk usually contains a
...
Download as [[file:org-6.12b.zip][zip file]] or [[file:org-6.12b.tar.gz][gzipped tar archive]].  These archives contain
