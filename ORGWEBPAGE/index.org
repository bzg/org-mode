...
* Current Version (6.20e)

The current version is 6.20e.  To see what has changed in recent
...
4.67d.  Emacs 23.1 release is expected to ship with 6.20c.  The latest
...
Download as [[file:org-6.20e.zip][zip file]] or [[file:org-6.20e.tar.gz][gzipped tar archive]].  These archives contain
