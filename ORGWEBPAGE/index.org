...
* Current Version (6.12) and Compatibility

The current version is 6.12.  To see what has changed in recent
...
Download as [[file:org-6.12.zip][zip file]] or [[file:org-6.12.tar.gz][gzipped tar archive]].  These archives contain
