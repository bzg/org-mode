...
** Talks about Org-mode, by Carsten Dominik
   Check out the [[file:talks/index.org::#sec-1.1][Google Tech Talk]] about Org-mode, and the talk given
   at the [[file:talks/index.org::#sec-1.2][Max Planck Institute for Neurological Research]]
** Mailing list
   :PROPERTIES:
