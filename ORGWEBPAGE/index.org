...
* Current Version (6.17b) and Compatibility

The current version is 6.17b.  To see what has changed in recent
...
Download as [[file:org-6.17b.zip][zip file]] or [[file:org-6.17b.tar.gz][gzipped tar archive]].  These archives contain
