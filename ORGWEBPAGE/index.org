...
* Documentation
** The Org manual
   - Read the [[file:manual/index.html][compact guide online]] or as [[file:orgguide.pdf][PDF document]].  The
     compact guide is a 40 page introduction to Org mode.
   - Read the [[file:manual/index.html][manual online]].  The manual
     covers all the bells and whistles in a systematic way. 
